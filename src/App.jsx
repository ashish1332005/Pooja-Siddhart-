      ...
      <AnimatePresence mode="wait">
        {!isGateOpened ? (
          ...
          >
            ...
            <section 
              id="venue-section" 
              className="relative w-full min-h-screen flex flex-col items-center justify-between py-2 sm:py-4 px-4 border-b border-[#d4af37]/30 overflow-hidden bg-no-repeat bg-center"
              style={{
            ...
            >
              ...
              <div className="relative z-10 w-full max-w-xl mx-auto flex flex-col items-center justify-between flex-1 h-full">
                <VenueSection />
              </div>
            </section>
