      ...
      <AnimatePresence mode="wait">
        {!isGateOpened ? (
          ...
          >
            ...
            <section 
              id="venue-section" 
              className="relative w-full min-h-screen min-h-[100dvh] flex flex-col items-center justify-center py-6 px-4 border-b border-[#d4af37]/30 overflow-hidden bg-no-repeat bg-center"
              style={{
