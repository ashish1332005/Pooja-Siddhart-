...
export default function VenueSection() {
  return (
    <div className="w-full flex flex-col items-center justify-start pt-2 sm:pt-4 pb-8 px-4 max-w-xl mx-auto">
      ...
      <motion.div 
        ...
        className="max-w-[240px] sm:max-w-[300px] mb-4 -mt-2 sm:-mt-4"
      >
        <img 
      ...
      <motion.div 
        ...
        className="w-full max-w-[340px] sm:max-w-[420px] rounded-3xl p-1 bg-gradient-to-b from-[#d4af37] via-[#fff0b3] to-[#aa7c11] shadow-[0_12px_35px_rgba(0,0,0,0.15)] mb-6 transition-transform hover:scale-[1.01]"
      >
