...
export default function VenueSection() {
  return (
    <div className="w-full h-full min-h-[calc(100vh-4rem)] flex flex-col items-center justify-between py-2 px-4 max-w-xl mx-auto">
      
      {/* Header Graphic (7.png: "The Venue") - Fixed at Top */}
      <motion.div 
        initial={{ opacity: 0, y: -40 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: false, amount: 0.3 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
        className="max-w-[260px] sm:max-w-[320px] pt-1 sm:pt-2 mb-2"
      >
        <img 
      ...
      {/* Main Content Group (Photo Card, Hotel Name & Directions) - Centered Vertically */}
      <div className="w-full flex-1 flex flex-col items-center justify-center my-auto py-2">
        {/* Resort Photo Card (9.png in Gold Bordered Rounded Frame) */}
        <motion.div 
          initial={{ opacity: 0, scale: 0.9, y: 40 }}
          whileInView={{ opacity: 1, scale: 1, y: 0 }}
          viewport={{ once: false, amount: 0.3 }}
          transition={{ duration: 0.9, delay: 0.2, ease: "easeOut" }}
          className="w-full max-w-[340px] sm:max-w-[420px] rounded-3xl p-1 bg-gradient-to-b from-[#d4af37] via-[#fff0b3] to-[#aa7c11] shadow-[0_12px_35px_rgba(0,0,0,0.15)] mb-4 sm:mb-5 transition-transform hover:scale-[1.01]"
        >
