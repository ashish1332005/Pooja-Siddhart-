...
export default function VenueSection() {
  return (
    <div className="w-full flex flex-col items-center justify-start pt-0 pb-4 px-4 max-w-xl mx-auto">
      ...
      <motion.div 
        ...
        className="max-w-[260px] sm:max-w-[320px] -mt-6 sm:-mt-10 mb-8 sm:mb-12"
      >
        <img 
